...
echo   - checkpoints/breast_tumors/fusion_breast_tumors_epoch100.pth
echo   - checkpoints/brain_tumors/fusion_brain_tumors_epoch100.pth
echo.
echo End time: %TIME%
echo ========================================
echo.
...
python evaluate_model.py ^
    --dataset brain_tumors ^
    --checkpoint checkpoints/brain_tumors/fusion_brain_tumors_epoch100.pth
